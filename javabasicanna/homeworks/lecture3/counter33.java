...
public class counter33 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            System.out.println("Enter the number of frags for player " + (i + 1) + " of the first team: ");
        ...
        for (int i = 0; i < 5; i++) {
            System.out.println("Enter the number of frags for player " + (i + 1) + " of the second team: ");
